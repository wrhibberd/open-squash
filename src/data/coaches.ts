...
const coaches = [
    {
        ...
        details: 'FiDi, HWR #50',
        image: amrImage,
        bio: '<p>For those deep in the squash world, Amr needs no introduction. He won the World Junior Championship in 2010, both Individual and Teams. As a college player in the US, Amr won the US college national individual championship in 2014 (beating a young sophomore named Ali Farag) and won the prestigious Skillman Award for sportsmanship. He then went on to be top 50 PSA player with nine titles to his name – legendary Trinity coach Paul Assaiante has said Amr “has magical hands, moves like a cat and reads the game really well.</p><p>But more important than Amr’s playing pedigree is the outstanding coaching career he has developed since. As an Egyptian National Junior Coach, he’s played an integral role in developing the current crop of top Egyptian juniors.</p><p>He currently is squash director for the Maadi Club in Cairo, and is the founder of S Unit where he coaches elite juniors and PSA players such as Omar Mosaad (former PSA #3), Youssef Soliman (PSA #11) and Melissa Alves (PSA # 19). Amr’s years of living, playing and studying in the US give him the ability to translate the best of the Egyptian game to squash in the US, and we’re incredibly excited to have him bring his talents and expertise to our junior programs, primarily at FiDi but also at our other locations.</p>'
    },
    {
        name: 'Peter Creed',
        ...
        image: peterImage,
        bio: '<p>Welshman Peter Creed has forged a reputation as one of the most energetic and exciting players to watch on the PSA World Tour. Training under the tutelage of six-time British Open Champion Jonah Barrington, he achieved a career high of #50 on the PSA World Tour, and captured 8 PSA titles and 9 national titles.</p><p>Peter was a key member of the Welsh team that finished 3rd at the 2019 WSF Men’s World Team Championship. He has competed in three Commonwealth Games, won a World Double Bronze medal, and represented Wales more than 150 times.</p><p>His goal here at Open Squash is to build the Red Team into a thriving, committed and hard-working group. He is also available for private lessons and will advise on adult programming. Catch Peter in the Open League this year, where he’s hoping to score some wins for the club!</p>'
    },
    {
        name: 'Ashgar Abbas',
    ...
    },
    {
        ...
        position: ' Assistant Coach',
        image: hannahImage,
        bio: '<p>Hannah hails from Ireland, where she was the 2017 Senior National Champion at the age of 17, and boasted the highest Under-19 European ranking of #2. She is a 4-time Irish Junior National Champion, 3-time Irish Junior Open Champion, and the first Irish woman in history to win the French Junior Open U-19! Hannah was captain of the women’s squash team at Harvard, where she worked with our own Mike Way to coach weekly squash clinics and summer camps. In her time on the Harvard women’s team, she went undefeated with a record of 41-0. Not bad! Now, Hannah is excited to be competing on the PSA World Tour—and for Ireland again—for her first full season. When not on the PSA tour, we are delighted to say Hannah will be coaching at Open Squash.</p>'
    },
    {
        name: 'Josh Easdon',
        ...
        details: 'Bryant Park',
        image: joshImage,
        bio: '<p>Josh Easdon is a certified squash coach with over 25 years of teaching experience. He has taught squash to juniors and adults at all of the major squash clubs in NYC including the Heights Casino and CityView Racquet Club. Josh has been playing squash since he was 7. Often in the top ten he reached #2 in the country and played on the US Junior Men’s Team. While earning his B.A. from Vassar College, Josh was the college’s number one squash player and an All-American and Senior Athlete. As a person living with dyslexia, he knows the challenges one faces in school and life. Josh carries this with him onto the squash court in each class he teaches, and conducts himself in a manner that makes his students feel comfortable, whether they are gifted athletes or find sports intimidating. His goal is to make squash accessible to as many people as possible.</p>'
    },
    {
        name: 'David Hughes',
        ...
        image: davidImage,
        bio: '<p>A level 3 certified coach with over 20 years of experience, David did his early coaching in Toronto, Vancouver, Guyana, and around the Caribbean. He was ranked in the top 10 in Canada during his junior and adult competitive career, and is a former 40+ champion in Ontario. As an active coach on the New York squash scene for the last ten years, he has worked with juniors and adults at all levels, guiding them on the technical and strategic aspects of the game.</p>'
    },
    {
        name: 'Habiba Mohamed',
        image: habibaImage,
